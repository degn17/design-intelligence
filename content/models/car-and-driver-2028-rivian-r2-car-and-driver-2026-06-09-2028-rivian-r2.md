# Model Card — Car and Driver 2028 Rivian R2

## 2028 Rivian R2

- Brand: Car and Driver
- Model: 2028 Rivian R2
- Category: new_car
- Published: 2026-06-09
- Data status: Real · RSS
- Collection method: rss
- Source: [Car and Driver](https://www.caranddriver.com/rivian/r2-2028)
- Image URL: https://hips.hearstapps.com/hmg-prod/images/2f451920-bead-42e8-8803-1efb69777260.jpg
...
This card is generated from a **Real · RSS** record and must retain attribution to [Car and Driver](https://www.caranddriver.com/rivian/r2-2028). RSS-collected records contain feed metadata only and require editorial review before design claims are added.
