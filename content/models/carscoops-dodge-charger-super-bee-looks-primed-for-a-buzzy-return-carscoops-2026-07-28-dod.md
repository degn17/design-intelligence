# Model Card — Carscoops Dodge Charger Super Bee Looks Primed For A Buzzy Return

## Dodge Charger Super Bee Looks Primed For A Buzzy Return

- Brand: Carscoops
- Model: Dodge Charger Super Bee Looks Primed For A Buzzy Return
- Category: other
...
The high-performance model debuts on August 7 and could have around 600 hp
...
This card is generated from a **Real · RSS** record and must retain attribution to [Carscoops](https://www.carscoops.com/2026/07/dodge-charger-suepr-bee-teaser/). RSS-collected records contain feed metadata only and require editorial review before design claims are added.
