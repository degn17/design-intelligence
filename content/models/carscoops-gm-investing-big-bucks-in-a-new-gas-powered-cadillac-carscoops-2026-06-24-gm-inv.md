# Model Card — Carscoops GM Investing Big Bucks In A New Gas-Powered Cadillac

## GM Investing Big Bucks In A New Gas-Powered Cadillac

- Brand: Carscoops
- Model: GM Investing Big Bucks In A New Gas-Powered Cadillac
- Category: other
...
The automaker is spending $150 million to build a new Cadillac in Spring Hill, Tennessee
...
This card is generated from a **Real · RSS** record and must retain attribution to [Carscoops](https://www.carscoops.com/2026/06/cadillac-spring-hill-investment/). RSS-collected records contain feed metadata only and require editorial review before design claims are added.
